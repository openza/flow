---
title: Architecture
description: Understanding the Openza Openza Flow codebase architecture
---

# Architecture

Openza Openza Flow follows Clean Architecture principles with feature-based organization.
